...
export class ImageTranscoder extends Transcoder {
	...
	async transcode(){
		...
		const meta = await this.getMetadata(this.asset.source);
...
export class LessTranscoder extends Transcoder {
	...
	async transcode(){
		...
		// NOT CALLING SUPER HERE, dont wanna copy over raw less file!!
...
export class TextTranscoder extends Transcoder {
	...
	async transcode(){
		await super.transcode();
		//TODO: Handlebars! (Preferably with metadata <3)
		return true;
	}
